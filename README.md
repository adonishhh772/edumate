...
**EduMate** is our project for the [Generative UI Global Hackathon: Agentic Interfaces](https://github.com/CopilotKit/Generative-UI-Global-Hackathon-Starter-Kit). We cloned the official CopilotKit hackathon starter kit and are customizing it into an AI-powered educational assistant with agentic interfaces.

> **Upstream:** This repo started from [CopilotKit/Generative-UI-Global-Hackathon-Starter-Kit](https://github.com/CopilotKit/Generative-UI-Global-Hackathon-Starter-Kit). The starter kit README and docs below are kept for reference; EduMate-specific changes will live on top of that foundation.

![Hackathon Banner](apps/frontend/public/banner.jpg)

## About the starter kit

Welcome to the **Generative UI Global Hackathon: Agentic Interfaces**! The upstream starter kit provides a complete AI-powered application with durable conversation threads, an agent-driven canvas, real-world MCP integrations, and a deployable MCP App — wired up with CopilotKit, LangChain Deep Agents, Gemini, A2UI, Notion MCP (via mcp-use), Manufact, and Daytona.
